    ...
    <!-- القائمة الجانبية -->
    <aside id="app-sidebar" class="fixed md:relative right-0 top-0 bottom-0 w-[var(--sidebar-width)] text-white flex-col flex z-30 transition-transform duration-300 ease-out translate-x-full md:translate-x-0" style="background: rgb(var(--sidebar-bg)); box-shadow: 4px 0 24px -4px rgb(0 0 0 / 0.08);">
        ...
        <nav class="flex-1 overflow-y-auto py-5 px-3 space-y-0.5">
            ...
            <a href="/dashboard" class="flex items-center px-3 py-2.5 min-h-[44px] text-sm font-medium rounded-xl <?= $nav['dashboard'] ? $activeClass : $inactiveClass ?> group transition-colors duration-200 focus:ring-2 focus:ring-blue-400 focus:ring-offset-2 focus:ring-offset-[#0f172a] cursor-pointer">
            ...
            <a href="/products" class="flex items-center px-3 py-2.5 min-h-[44px] text-sm font-medium rounded-xl <?= $nav['products'] ? $activeClass : $inactiveClass ?> group transition-colors duration-200 focus:ring-2 focus:ring-blue-400 focus:ring-offset-2 focus:ring-offset-[#0f172a] cursor-pointer">
                <i class="fa-solid fa-tags w-5 text-center ms-3 <?= $nav['products'] ? $activeIcon : $inactiveIcon ?>" aria-hidden="true"></i>
                المنتجات
            </a>
            <a href="/categories" class="flex items-center px-3 py-2.5 min-h-[44px] text-sm font-medium rounded-xl <?= $nav['categories'] ? $activeClass : $inactiveClass ?> group transition-colors duration-200 focus:ring-2 focus:ring-blue-400 focus:ring-offset-2 focus:ring-offset-[#0f172a] cursor-pointer">
                <i class="fa-solid fa-layer-group w-5 text-center ms-3 <?= $nav['categories'] ? $activeIcon : $inactiveIcon ?>" aria-hidden="true"></i>
                التصنيفات
            </a>
            <a href="/sales" class="flex items-center px-3 py-2.5 min-h-[44px] text-sm font-medium rounded-xl <?= $nav['sales'] ? $activeClass : $inactiveClass ?> group transition-colors duration-200 focus:ring-2 focus:ring-blue-400 focus:ring-offset-2 focus:ring-offset-[#0f172a] cursor-pointer">
            ...
            <a href="/reports" class="flex items-center px-3 py-2.5 min-h-[44px] text-sm font-medium rounded-xl <?= $nav['reports'] ? $activeClass : $inactiveClass ?> group transition-colors duration-200 focus:ring-2 focus:ring-blue-400 focus:ring-offset-2 focus:ring-offset-[#0f172a] cursor-pointer">
            ...
            <a href="/users" class="flex items-center px-3 py-2.5 min-h-[44px] text-sm font-medium rounded-xl <?= $nav['users'] ? $activeClass : $inactiveClass ?> group transition-colors duration-200 focus:ring-2 focus:ring-blue-400 focus:ring-offset-2 focus:ring-offset-[#0f172a] cursor-pointer">
                <i class="fa-solid fa-users-gear w-5 text-center ms-3 <?= $nav['users'] ? $activeIcon : $inactiveIcon ?>" aria-hidden="true"></i>
                المستخدمون
            </a>
            <a href="/activity-log" class="flex items-center px-3 py-2.5 min-h-[44px] text-sm font-medium rounded-xl <?= $nav['activity'] ? $activeClass : $inactiveClass ?> group transition-colors duration-200 focus:ring-2 focus:ring-blue-400 focus:ring-offset-2 focus:ring-offset-[#0f172a] cursor-pointer">
                <i class="fa-solid fa-clock-rotate-left w-5 text-center ms-3 <?= $nav['activity'] ? $activeIcon : $inactiveIcon ?>" aria-hidden="true"></i>
                سجل النشاط
            </a>
            <a href="/settings" class="flex items-center px-3 py-2.5 min-h-[44px] text-sm font-medium rounded-xl <?= $nav['settings'] ? $activeClass : $inactiveClass ?> group transition-colors duration-200 focus:ring-2 focus:ring-blue-400 focus:ring-offset-2 focus:ring-offset-[#0f172a] cursor-pointer">
