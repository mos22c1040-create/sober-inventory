...
<body class="bg-slate-900 text-white min-h-screen flex flex-col antialiased">
    ...
    <main class="flex-1 flex flex-col p-4">
        <p class="text-sm text-slate-400 text-center mb-4">ربط الجوال بالحاسوب (كابل أو نفس الشبكة) — امسح الباركود وسيظهر على الحاسوب تلقائياً.</p>
    ...
    (function() {
        ...
        function sendToPc(barcode) {
            ...
            fetch('/api/barcode-push', {
                ...
                showResult(false, 'تحقق من الاتصال بالحاسوب (نفس الشبكة أو الربط بالكابل)');
                status.textContent = 'وجّه الكاميرا نحو الباركود';
            });
        }
